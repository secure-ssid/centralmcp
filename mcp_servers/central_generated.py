"""MCP server — generated Aruba Central operations (aruba-central-generated).
...
* Writes (POST/PUT/PATCH/DELETE) run behind the Central write gate
  (``CENTRALMCP_CENTRAL_WRITES``, default enabled) and every generated write
...
Registration is guarded by ``CENTRALMCP_CENTRAL_GENERATED_TOOLS`` and defaults
...
mcp = FastMCP("aruba-central-generated")
...
_EXECUTE_HINT = (
    ...
    "(requires CENTRALMCP_CENTRAL_WRITES=1)."
)
