...
| `CENTRALMCP_READONLY` | Server-wide kill switch: hides every tool not annotated read-only (writes, destructive ops, AND diagnostics like ping/cable test) across all backends | off |
