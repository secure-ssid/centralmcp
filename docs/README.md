...
| [RAG-ARCHITECTURE.md](RAG-ARCHITECTURE.md) | RAG backend decision (embedded LanceDB + SQLite lookup + fastembed, no Docker), reconciliation with the audit's Redis pick, migration plan, eval harness + measured baseline. |
