...
| Apstra | status, guarded GET/write, blueprint, anomaly, rack, routing-zone, and system-info reads | `APSTRA_BASE_URL`, `APSTRA_API_TOKEN` | Read/write starter; writes dry-run by default |
