...
| ArubaOS 8 | status, guarded GET/write, show-command, AP inventory/active/client/radio/BSS, and WLAN/AP-group reads | `AOS8_BASE_URL`, `AOS8_API_TOKEN` | Read/write starter; writes dry-run by default |
