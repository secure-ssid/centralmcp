...
only that manifest to ``mcp_servers/openapi_gen/manifests/glp.json``.
...
from mcp_servers.openapi_gen.ir import OpenApiError, SpecParser  # noqa: E402

PLATFORM = "glp"

UPSTREAM_REPO = "https://github.com/nowireless4u/hpe-networking-mcp"
UPSTREAM_REF = "da9c834651f2a6a3842544b3aac7d3a48da7f766"
