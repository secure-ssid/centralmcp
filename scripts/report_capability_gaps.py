...
MANIFEST_DIR = ROOT / "mcp_servers" / "openapi_gen" / "manifests"
...
GAPS = (
    ...
    (
        ...
        "`scripts/generate_edgeconnect_tools.py`, `mcp_servers/openapi_gen/compatibility.py`, "
    ...
    (
        ...
        "`scripts/generate_axis_manifest.py`, `mcp_servers/openapi_gen/manifests/axis.json`, "
        "`mcp_servers/axis.py`",
    ),
    (
        4,
        ...
        "`mcp_servers/tool_router.py`, `mcp_servers/shared.py`, `docs/product-workflows.md`",
    ),
)
...
def curated_capabilities(module_names: tuple[str, ...]) -> Counter[str]:
    ...
    for module_name in module_names:
        path = ROOT / "mcp_servers" / module_name
...
def render_report() -> str:
    ...
    lines.extend(
        [
            ...
            f"{_fmt(registered_total)} executable backend tools. The three minimal-router "
    ...
    lines.extend(
        [
            ...
            f"{_fmt(benchmark['counts']['indexed_endpoints'])}** compares centralmcp "
    ...
    lines.extend(
        [
            ...
            "```",
            "",
            "The script parses committed FastMCP decorators, committed generated manifests, "
