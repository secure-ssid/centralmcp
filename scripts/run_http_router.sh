...
allowed_keys = {
    ...
    "CENTRALMCP_NORMALIZE_MACS",
    "CENTRALMCP_SWITCH_GROUP_NAME",
    "CENTRALMCP_EMBED_PROVIDERS",
    "CENTRALMCP_NOMIC_PREFIXES",
    "CENTRALMCP_ROUTER_RESPONSE_MAX_ITEMS",
    "CENTRALMCP_ROUTER_RESPONSE_MAX_BYTES",
    "CENTRALMCP_ROUTER_BATCH_RESPONSE_MAX_BYTES",
    "CENTRALMCP_ROUTER_CURSOR_TTL_SECONDS",
    "CENTRALMCP_CENTRAL_GENERATED_TOOLS",
    "CENTRALMCP_GLP_GENERATED_TOOLS",
    "CENTRALMCP_AOS8_GENERATED_TOOLS",
    "CENTRALMCP_APSTRA_GENERATED_TOOLS",
    "CENTRALMCP_CLEARPASS_GENERATED_TOOLS",
    "CENTRALMCP_MIST_GENERATED_TOOLS",
    "CENTRALMCP_UXI_GENERATED_TOOLS",
    "CENTRALMCP_AOS8_ROLLBACK_WRITES",
