"""Unit tests for pipeline.router_automation.
...
- Artifact payload shaping helpers produce a shape that
  pipeline.artifact_contracts accepts.
"""

from __future__ import annotations

from pipeline import artifact_contracts as contracts
from pipeline import router_automation as ra
...
class TestArtifactPayloadShaping:
    ...
    def test_reconciliation_plan_payload_round_trips(self, tmp_path):
        ...
        entries, excluded_detail, excluded_total = ra.partition_reconciliation_candidates(
            [
                {"tool": "list_devices", "server": "aruba-monitoring", "platform": "central",
                 "capability": "read", "enabled": True},
                {"tool": "reboot_device", "server": "aruba-ops", "platform": "central",
