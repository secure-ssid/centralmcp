"""Unit tests for pipeline.live_test_config.
...
from pipeline import live_test_config as lt
...
class TestStatusApi:
    ...
    def test_status_reports_env_var_names_and_booleans_only(self):
        ...
        assert status["read_env_var"] == "CENTRALMCP_LIVE_TEST_CENTRAL_READ"
        assert status["write_env_var"] == "CENTRALMCP_LIVE_TEST_CENTRAL_WRITE"
