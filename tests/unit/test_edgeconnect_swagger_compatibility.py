...
from mcp_servers.openapi_gen.compatibility import (
    CompatibilityError,
    build_compatibility_report,
    dumps_report,
)
from mcp_servers.openapi_gen.ir import SpecParser
from mcp_servers.openapi_gen.manifest import sha256_bytes
...
def test_committed_edgeconnect_baseline_digest_and_1216_operations_are_current():
    manifest_path = ROOT / "mcp_servers/openapi_gen/manifests/edgeconnect.json"
    provenance_path = ROOT / "mcp_servers/openapi_gen/provenance/edgeconnect.json"
