...
from pipeline import compliance as c
...
class TestValidatePolicy:
    ...
    def test_regex_total_quantifier_bound_enforced(self):
        # This module's actual policy (see pipeline.compliance's module
...
# ---------------------------------------------------------------------------
# Artifact payload shaping accepted by pipeline.artifact_contracts
# ---------------------------------------------------------------------------
...
class TestMessageTruncationNeverExceedsArtifactBound:
    ...
    def test_900_char_message_via_router_tool_produces_no_artifact_error(self):
        ...
        # (mirrors mcp_servers/tool_router.py's own artifact_error
        # degrade-gracefully contract) rather than only pipeline.compliance
        # directly.
...
class TestAmplificationBounds:
    ...
    def test_bound_actual_final_serialized_bytes_never_exceeds_artifact_ceiling(self):
        ...
        # ceiling (see pipeline.artifact_contracts.MAX_COMPLIANCE_VALUE_CHARS).
