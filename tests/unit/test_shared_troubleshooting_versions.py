...
- CENTRALMCP_TROUBLESHOOTING_API_VERSION=v1alpha1/legacy pins the legacy
...
class TestVersionOrder:
    def test_default_order_is_v1_first(self, monkeypatch):
        monkeypatch.delenv("CENTRALMCP_TROUBLESHOOTING_API_VERSION", raising=False)
    ...
    def test_legacy_override_pins_v1alpha1_first(self, monkeypatch, value):
        monkeypatch.setenv("CENTRALMCP_TROUBLESHOOTING_API_VERSION", value)
    ...
    def test_unrecognized_override_falls_back_to_default(self, monkeypatch):
        monkeypatch.setenv("CENTRALMCP_TROUBLESHOOTING_API_VERSION", "v99")
        assert shared.troubleshooting_version_order() == ("v1", "v1alpha1")
...
class TestCandidates:
    ...
    def test_legacy_pin_reverses_order(self, monkeypatch):
        monkeypatch.setenv("CENTRALMCP_TROUBLESHOOTING_API_VERSION", "legacy")
