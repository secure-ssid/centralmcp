...
from pipeline.clients.glp_client import _V2BETA1_WRITES_FLAG
...
class TestWriteStatus:
    def test_reports_disabled_gate_and_independence(self, monkeypatch):
        ...
        assert "CENTRALMCP_CENTRAL_WRITES" in status["independent_of"]
    ...
    def test_blocked_response_names_only_the_glp_flag(self, monkeypatch):
        ...
        assert "independent of CENTRALMCP_CENTRAL_WRITES" in result["error"]
