"""Pure-python tests for `pipeline.aos8_rollback` (no MCP/network dependency)."""
...
from pipeline.aos8_target_adapters import AdapterError, CandidateAction, Operation, WriteGateError
